-- =====================================================================
-- TABLE: public.published_file_library
...
create table public.published_file_library (
  ...
  -- Constraints
  constraint unique_published_file_path_per_course unique (course_id, path),
...
create index idx_published_file_library_course_id on public.published_file_library(course_id);
create index idx_published_file_library_organization_id on public.published_file_library(organization_id);
create index idx_published_file_library_created_by on public.published_file_library(created_by);
create index idx_published_file_library_updated_by on public.published_file_library(updated_by);
...
drop index if exists idx_published_file_library_org_created_by;
drop index if exists idx_published_file_library_org_updated_by;

-- Replace with more general multitenant-aware indexes
create index idx_published_file_library_created_by_org on public.published_file_library(created_by, organization_id);
create index idx_published_file_library_updated_by_org on public.published_file_library(updated_by, organization_id);

-- Other useful indexes
create index idx_published_file_library_org_course on public.published_file_library (organization_id, course_id);
...
before insert or update on public.published_file_library
for each row
execute function public.set_file_type_from_extension();

-- Automatically update `updated_at` timestamp
create trigger trg_update_timestamp
before update on public.published_file_library
for each row
