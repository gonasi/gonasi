...
comment on column public.organizations.handle is 'Unique handle for the organization. Validation handled at application level with Zod.';

-- ===================================================
-- INDEXES
-- ===================================================

create unique index idx_organizations_handle_unique on public.organizations(handle);
