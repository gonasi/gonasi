...
comment on function public.calculate_leaderboard_ranks is 'Calculates and updates leaderboard rankings for a session (higher score wins, faster time breaks ties)';
