-- ==========================================================================
-- FUNCTION: process_subscription_upgrade_payment
-- ==========================================================================
-- PURPOSE:
--   Processes Paystack subscription upgrade payments.
...
create or replace function public.process_subscription_upgrade_payment(
...
comment on function public.process_subscription_upgrade_payment is
  'Handles Paystack subscription upgrade payments: creates ledger entries only. '
