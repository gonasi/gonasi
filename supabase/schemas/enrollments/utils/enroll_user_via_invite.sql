-- ============================================================================
-- FUNCTION: enroll_user_via_invite
-- ============================================================================
-- PURPOSE:
--   Enrolls a user into a published course via a course invitation (free tier).
--   This function:
--     - Validates the invite is still valid and not used
--     - Enrolls the user using the standard free enrollment flow
--     - Marks the invite as accepted
--     - Links the enrollment to the invite
-- ============================================================================
create or replace function public.enroll_user_via_invite(
  p_user_id uuid,
