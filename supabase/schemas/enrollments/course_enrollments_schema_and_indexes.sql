...
create table public.course_enrollments (
  ...
  cohort_id uuid,                                                  -- FK: Optional cohort assignment (nullable)
...
-- composite index for cohort filtering within a course
create index idx_course_enrollments_course_cohort on public.course_enrollments(published_course_id, cohort_id);
