-- ====================================================================================
-- RLS Policies for: public.chapter_progress
-- DESCRIPTION: Controls access to chapter progress records.
-- ====================================================================================
...
using (
  exists (
    ...
    where p.id = chapter_progress.user_id
      and (
        p.is_public = true
        or exists (
          select 1
          ...
          where m1.user_id = chapter_progress.user_id
