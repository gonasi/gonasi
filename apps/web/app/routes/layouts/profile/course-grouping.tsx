...
import type { CourseOverviewType } from '~/routes/profile/courses/courseId/course-id-index';
...
export default function UpsertCourseLayout() {
  ...
  const getBackUrl = () => {
    if (currentStepIndex > 0) {
      ...
      if (prevStep) {
        return `/${params.username}/courses/${params.courseId}/overview/grouping/${prevStep.path}`;
      }
    }
    return '';
  };
    ...
    <Modal open>
      <Modal.Content size='md'>
        <Modal.Header
          ...
          closeRoute={`/${params.username}/courses/${params.courseId}/overview`}
          leadingIcon={
