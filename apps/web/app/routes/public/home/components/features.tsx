...
export function Features() {
  const features = [
    ...
    },
    {
      ...
      description:
        'Track progress, identify bottlenecks, and measure real skill development.',
    ...
    },
    {
      ...
      description:
        'White-label your learning platform with custom domains, colors, and branding.',
    ...
    <section className='bg-background py-20 md:py-32'>
      <div className='container mx-auto px-6'>
        ...
        >
          ...
          >
            Powerful tools designed for educators, trainers, and content creators who want to make
            a real impact.
          </motion.p>
        </motion.div>
          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                className='shadow-lg hover:shadow-xl bg-card border-border/50 group relative overflow-hidden rounded-2xl border p-8 transition-shadow'
              >
                {/* Gradient accent on hover */}
                <motion.div
                  className={`bg-gradient-to-br ${feature.color} absolute -right-16 -top-16 h-40 w-40 rounded-full opacity-0 blur-3xl transition-opacity duration-500 group-hover:opacity-15`}
                  initial={false}
                />
                ...
                <div className='relative space-y-5'>
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.3, ease: [0.22, 1, 0.36, 1] }}
                    className={`bg-gradient-to-br ${feature.color} shadow-lg flex h-16 w-16 items-center justify-center rounded-xl`}
                  >
