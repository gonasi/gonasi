...
import { fetchCoursePricing, fetchOrganizationCourseOverviewById } from '@gonasi/database/courses';
...
export async function loader({ params, request }: Route.LoaderArgs) {
  ...
  const redirectPath = `/${params.organizationId}/builder/${params.courseId}/overview`;
