...
export async function loader({ params, request }: Route.LoaderArgs) {
  ...
  if (!course) {
    return redirectWithError(
      `/${params.organizationId}/courses/${params.courseId}/published`,
...
export default function LearnersIndex({ params, loaderData }: Route.ComponentProps) {
  ...
  const closeRoute = `/${params.organizationId}/courses/${params.courseId}/published`;

  const basePath = useMemo(
    () => `/${params.organizationId}/courses/${params.courseId}/learners`,
