    ...
    <>
      <div className='flex flex-col gap-6'>
        <div className='flex items-center justify-between'>
          ...
          <div>
            <NavLinkButton
              to={`/${params.organizationId}/courses/${params.courseId}/learners/cohorts/new`}
              leftIcon={<Plus />}
            >
              New Cohort
            </NavLinkButton>
              ...
              <Card key={cohort.id} className='relative rounded-none'>
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align='end'>
                        <DropdownMenuItem asChild>
                          <Link
                            to={`/${params.organizationId}/courses/${params.courseId}/learners/cohorts/${cohort.id}/edit`}
                          >
                        ...
                        <DropdownMenuItem asChild>
                          <Link
                            to={`/${params.organizationId}/courses/${params.courseId}/learners/cohorts/${cohort.id}/delete`}
                ...
                <CardContent className='space-y-3'>
                  ...
                  <div className='flex items-center justify-end'>
                    <div>
                      <NavLinkButton
                        to={`/${params.organizationId}/courses/${params.courseId}/learners/cohorts/${cohort.id}/assign-users`}
                        leftIcon={<BookUser />}
                        variant='secondary'
                        size='sm'
                      >
