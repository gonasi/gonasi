      ...
      <div className='flex w-full items-end justify-between py-4'>
        ...
        <div>
          {isPaid && canEdit ? (
            <NavLinkButton
              variant='secondary'
              to={`/${params.organizationId}/courses/${params.courseId}/pricing/manage-pricing-tier/add`}
              leftIcon={<Plus />}
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align='end'>
                      <DropdownMenuItem asChild>
                        <NavLink
                          to={`/${params.organizationId}/courses/${params.courseId}/pricing/manage-pricing-tier/${priceTier.id}/edit`}
                      ...
                      {isPaid ? (
                        <DropdownMenuItem asChild>
                          <NavLink
                            to={`/${params.organizationId}/courses/${params.courseId}/pricing/manage-pricing-tier/${priceTier.id}/delete`}
