          ...
          >
            <div className='flex max-w-md items-center justify-center md:max-w-sm'>
              <CourseThumbnail
                ...
                editLink={
                  canEditCourse
                    ? `/${params.organizationId}/courses/${courseId}/overview/edit-thumbnail`
                    : undefined
                }
              />
            </div>
            <div className='flex-1'>
              <CourseInfoOverview
                ...
                editLink={
                  canEditCourse
                    ? `/${params.organizationId}/courses/${courseId}/overview/edit-details`
                    : undefined
                }
              />
            </div>
          ...
          >
            ...
            <div className='max-w-sm'>
              <CourseCategoryOverview
                ...
                editLink={
                  canEditCourse
                    ? `/${params.organizationId}/courses/${courseId}/overview/edit-grouping`
                    : undefined
                }
              />
            </div>
