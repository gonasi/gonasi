...
export async function action({ params, request }: Route.ActionArgs) {
  ...
  return redirectWithSuccess(
    `/${params.organizationId}/courses/${params.courseId}/content/${params.chapterId}/${lessonData.id}/lesson-blocks`,
    message,
  );
}
  ...
  return (
    <Modal open>
      <Modal.Content size='sm'>
        <Modal.Header
          title='New lesson'
          closeRoute={`/${params.organizationId}/courses/${params.courseId}/content/${params.chapterId}/lessons`}
        />
        <Modal.Body>
