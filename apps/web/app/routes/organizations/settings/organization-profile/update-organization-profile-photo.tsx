...
export function meta() {
  return [
    ...
    {
      name: 'description',
      content: 'Upload a new profile picture to personalize your organization.',
    },
  ];
}
...
// UI component: Update Organization Profile Photo
export default function UpdateOrganizationProfilePicture({ params }: Route.ComponentProps) {
  ...
  const handleProfilePhotoUpload = async () => {
    ...
    try {
      ...
      const prepareResponse = await fetch('/api/organizations/prepare-profile-photo-upload', {
        method: 'POST',
        body: prepareData,
      });
      ...
      const confirmResponse = await fetch('/api/organizations/confirm-profile-photo-upload', {
        method: 'POST',
        body: confirmData,
      });
            ...
            >
              <div className='space-y-4'>
                <div>
                  ...
                  />
                  <FormDescription>
                    Choose a new photo to represent your organization on Gonasi.
                  </FormDescription>
                  {croppedFile && (
