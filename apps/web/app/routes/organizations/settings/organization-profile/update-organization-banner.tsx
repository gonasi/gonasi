...
// UI component: Update Organization Banner
export default function UpdateOrganizationBanner({ params }: Route.ComponentProps) {
  ...
  const handleBannerUpload = async () => {
    ...
    try {
      ...
      const prepareResponse = await fetch('/api/organizations/prepare-banner-upload', {
        method: 'POST',
        body: prepareData,
      });
      ...
      const confirmResponse = await fetch('/api/organizations/confirm-banner-upload', {
        method: 'POST',
        body: confirmData,
      });
            ...
            <div className='h-full space-y-4'>
              <div className='bg-card relative h-[50vh] w-full'>
                <Cropper
                  ...
                  crop={crop}
                  zoom={zoom}
                  aspect={263 / 100} // Wide aspect ratio for banners
