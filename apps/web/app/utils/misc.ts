 ...
 */
export function mergeHeaders(...headers: (ResponseInit['headers'] | null | undefined)[]) {
 ...
 */
export function combineHeaders(...headers: (ResponseInit['headers'] | null | undefined)[]) {
 ...
 */
export function combineResponseInits(...responseInits: (ResponseInit | null | undefined)[]) {
...
function callAll<Args extends unknown[]>(...fns: (((...args: Args) => unknown) | undefined)[]) {
