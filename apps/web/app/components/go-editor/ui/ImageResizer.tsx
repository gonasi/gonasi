...
export default function ImageResizer({
  ...
  return (
    <div ref={controlWrapperRef}>
      ...
      />
      <div
        className='bg-primary absolute -top-[5px] -right-[5px] h-2 w-2 cursor-ne-resize'
        onPointerDown={(e) => handlePointerDown(e, Direction.north | Direction.east)}
      />
      <div
        className='bg-primary absolute top-1/2 -right-[5px] h-2 w-2 -translate-y-1/2 cursor-e-resize'
        onPointerDown={(e) => handlePointerDown(e, Direction.east)}
      />
      <div
        className='bg-primary absolute -right-[5px] -bottom-[5px] h-2 w-2 cursor-se-resize'
        onPointerDown={(e) => handlePointerDown(e, Direction.south | Direction.east)}
      />
      <div
        className='bg-primary absolute -bottom-[5px] left-1/2 h-2 w-2 -translate-x-1/2 cursor-s-resize'
        onPointerDown={(e) => handlePointerDown(e, Direction.south)}
      />
      <div
        className='bg-primary absolute -bottom-[5px] -left-[5px] h-2 w-2 cursor-sw-resize'
        onPointerDown={(e) => handlePointerDown(e, Direction.south | Direction.west)}
      />
      <div
        className='bg-primary absolute top-1/2 -left-[5px] h-2 w-2 -translate-y-1/2 cursor-w-resize'
        onPointerDown={(e) => handlePointerDown(e, Direction.west)}
      />
      <div
        className='bg-primary absolute -top-[5px] -left-[5px] h-2 w-2 cursor-nw-resize'
