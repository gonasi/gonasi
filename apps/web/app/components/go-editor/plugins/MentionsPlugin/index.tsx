...
function checkForAtSignMentions(text: string, minMatchLength: number): MenuTextMatch | null {
  ...
  if (match !== null) {
    ...
    if (!matchingString || !match[1] || !match[2]) return null;
      ...
      menuRenderFn={(
        ...
        anchorElementRef.current && results.length
          ? ReactDOM.createPortal(
              ...
              >
                <div role='group' aria-label='Mention suggestions'>
                  <ul role='listbox' aria-label='Available mentions' id='mentions-listbox'>
