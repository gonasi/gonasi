...
import {
  type MultipleChoiceMultipleAnswersSettingsSchemaType,
...
export function EditMultipleChoiceMultipleAnswersSettings({
  block,
}: EditPluginSettingsComponentProps) {
  const pending = useIsPending();
  const settings = block.settings as MultipleChoiceMultipleAnswersSettingsSchemaType;
