...
export function BuilderYouTubeEmbedPlugin({ block }: BuilderYouTubeEmbedPluginProps) {
  ...
  const watchCaptions = methods.watch('settings.captions');
  const watchAllowSeek = methods.watch('settings.allowSeek');
  const watchPrivacyEnhanced = methods.watch('settings.privacyEnhanced');
                      ...
                      <div className='grid gap-4'>
                        ...
                        <div className='space-y-3'>
                          ...
                          <div className='flex items-center space-x-2'>
                            <Checkbox
                              id='captions'
                              checked={watchCaptions}
                              onCheckedChange={(checked) =>
                                methods.setValue('settings.captions', checked === true)
                              }
                            />
                          ...
                          <div className='flex items-center space-x-2'>
                            <Checkbox
                              id='privacyEnhanced'
                              checked={watchPrivacyEnhanced}
                              onCheckedChange={(checked) =>
                                methods.setValue('settings.privacyEnhanced', checked === true)
                              }
                            />
                        ...
                        {/* Time controls */}
                        <div className='space-y-3'>
                          <p className='text-muted-foreground text-sm font-medium'>Time Controls</p>
                          ...
                          <div className='space-y-2'>
                            ...
                            <Input
                              ...
                              onChange={(e) =>
                                methods.setValue('settings.startTime', parseInt(e.target.value) || 0)
                              }
                            />
                          </div>
